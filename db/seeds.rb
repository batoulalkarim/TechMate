...
Match.create(requestor_id: zelie.id, receiver_id: iba.id, status: "pending", likes: true)
Match.create(requestor_id: zelie.id, receiver_id: alex.id, status: "pending", likes: true)
Match.create(requestor_id: zelie.id, receiver_id: klem.id, status: "pending", likes: true)
Match.create(requestor_id: zelie.id, receiver_id: johnny.id, status: "pending", likes: true)
